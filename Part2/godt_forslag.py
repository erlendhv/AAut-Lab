...
for n in range(1, 10):
    for m in range(10):
        for d in range(10):
            ...
            y_pred_norm = predict_arx(u_train_norm, y_train_norm[:n], theta, n, m, d)
...
# Predict on test set
y_test_pred_norm = predict_arx(u_test_norm, y_train_norm[-best_params[0]:], best_theta, *best_params)
